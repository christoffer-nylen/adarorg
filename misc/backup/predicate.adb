...
package body Predicate is
   ...
   begin
      return (Elem, Value, Absolute_Id, Relative_Id, Contains_Function_Call, Number_Of_Equal_Clauses);
   end Make_Clause;

   procedure Increment_Predicate_Counter is
   begin
      Predicate_Counter := Predicate_Counter+1;
   end Increment_Predicate_Counter;
   ...
   function Is_Equal (N1 : Predicate.Predicate_Tree.Node_Access;
      ...
      function Recursive_Is_Equal(Elem1 : Asis.Element; Elem2 : Asis.Element) return Boolean is
         ...
         Expr_Kind : Asis.Expression_Kinds := Expression_Kind (Elem1);
      begin
