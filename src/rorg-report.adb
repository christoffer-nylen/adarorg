...
package body Rorg.Report is
   ...
   begin
      ...
      while not End_Of_Filelist loop
         ...
         Offset_Last := Offset_Last + Instrumentation_Data.Data.Relops_Tested;
      ...
      Put_Line("            Failed                  : " & Natural'Wide_Image(Instrumentation_Data.Data.Relops_Tested-Passed));
      Put_Line("            Ignored                 : " & Natural'Wide_Image(Instrumentation_Data.Data.Relops_Total-Instrumentation_Data.Data.Relops_Tested));
      Put_Line("--------------------------------------------------------------------------------");
      Put_Line("                    Overall Rorg Coverage: " & Natural'Wide_Image(Passed) & "/" & Trim(Natural'Wide_Image(Instrumentation_Data.Data.Relops_Tested), Both));
      Put_Line("================================================================================");
